...
colors.editor.selection = functions.adjust_color_value(term_colors.colors.selection_background, 1 + (value_adjustment_scale * color_mod_direction * -1)) -- TODO: needs to be closer in direction to the background
