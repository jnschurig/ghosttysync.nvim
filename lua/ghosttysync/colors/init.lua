...
colors.editor.border       = functions.adjust_color_value(colors.editor.selection, standard_adjustment * 2)
-- colors.editor.line_numbers = functions.raise_contrast(colors.editor.border, colors.editor.bg, 20)
colors.editor.line_numbers = functions.adjust_color_value(colors.editor.border, standard_invert_adjustment * 1.5)
