...
colors.editor.selection = functions.adjust_color_value(term_colors.colors.selection_background, 1 + (0.5 * color_mod_direction)) -- TODO: needs to be closer in direction to the background
