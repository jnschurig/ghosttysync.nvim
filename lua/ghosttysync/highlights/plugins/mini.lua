...
M.load = function()
    local plugin_hls = {
        ...
        MiniJump2dSpotAhead           = { fg = m.bright_blue, bg = e.bg_alt, nocombine = true },
        MiniJump2dSpotUnique          = { fg = m.magenta, bold = true, nocombine = true },
        MiniMapNormal                 = { link = "NormalFloat" },
        MiniMapSymbolCount            = { fg = m.magenta },
        ...
        MiniStarterQuery              = { fg = m.bright_blue },
        ...
        MiniStatuslineModeVisual      = { fg = e.bg, bg = m.magenta, bold = true },
